...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Harshit Mishra',", type: 'array-item' },
    { code: "    role: 'Full Stack Developer',", type: 'array-item' },
    { code: "    bio: 'National SIH Grand Finalist 2025 --Building modern web experiences'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          ...
          <p className={styles.bio}>
            I build elegant, responsive web and desktop applications with modern
